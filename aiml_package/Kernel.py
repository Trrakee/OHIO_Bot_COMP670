# -*- coding: latin-1 -*-
"""This file contains the public interface to the aiml_package module."""
...
class Kernel:
    ...
    def __init__(self):
        ...
        self._version = "python-aiml_package {}".format(VERSION)
    ...
    def _processGender(self, elem, sessionID):
        ...
        This subsitution is handled by the aiml_package.WordSub module.
